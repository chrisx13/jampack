...
| **6 Gestion** | **Agenda consolidé** (échéances & tâches à venir, 7/30/90 j, retards) | ✅ | `analytics.agenda` (tâches CRM + factures clients/fournisseurs + livraisons), `Agenda.tsx` (domaine Gestion) |
