...
- **REG-7 (M)** **TVA France** : taux 20/10/5,5/2,1 ✅ + **CA3** ✅ + **franchise en base** (293 B) ✅ + **autoliquidation** (283-2) ✅ ; CA12, TVA sur débits/encaissements ⏳ (DO-8) — voir [Conformité §3.7](CONFORMITE.md).
