...
- **REG-3 (M)** **RGPD / CNIL** : registre des traitements, minimisation, hébergement UE, droits des personnes. 🔧 (accès/portabilité **export** ✅, opposition ✅, rectification ✅, **effacement anonymisant** ✅ ; limitation ⏳) — voir [Sécurité & RGPD](SECURITE-RGPD.md).
